...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps.GroupBy(e => e.Job).Select(e =>
                new
                {
                    Praca = e.Key,
                    LicbaPracownikow = e.Key.Length
                });
        ...
        public void Przyklad10Button_Click()
        {
            ...
            Emp[] emp = new Emp[] {new Emp {Ename = "Brak wartosci,", HireDate = null, Job = null}};
                
            var res = Emps.Union(emp)
                .Select(e =>
                    new
                    {
                        e.Ename,
